...
if __name__ == '__main__':
    ...
    graph = Graph()
    graph.create_p_random_graph(100, 0.1)
    vc1 = two_approximate_vertex_cover(graph)
    vc2 = greedy_hill_climbing(graph, [])
    vc3 = random_restart_hill_climbing(graph, 100)
    vc4 = ghc_weighted(graph, [], 100)
    print(len(vc1))
    print(len(vc2))
    print(len(vc3))
    print(len(vc4))
    graph.draw_vertex_cover(vc3)
